...
def codeDenormalize(data_list, code = 50, filepath = '../data/TBrain_Round2_DataSet_20180615/tetfp.csv', encoding = 'cp950'):
    """
...
if __name__ == '__main__':
    ...
    filepath = '../data/TBrain_Round2_DataSet_20180615/tetfp.csv'
